...
def how_it_works():
    with st.expander("How it works"):
        st.markdown(
            ...
            Because the independent variable is discrete, the objective and constraint non-linear (because $F$ is non linear), the optimal solution is searched using scipy implementation of Differential Evolution.
            """
        )
